...
<#--<body>-->
    ...
    <#--<nav class="blog-nav layui-header">-->
        <#--<div class="blog-container">-->
            ...
            <#--<ul class="layui-nav" lay-filter="nav">-->
                ...
                <#--</li>-->
                <#--<li class="layui-nav-item">-->
                    <#--<a href="article.ftl"><i class="fa fa-file-text fa-fw"></i>&nbsp;文章专栏</a>-->
                <#--</li>-->
                <#--<li class="layui-nav-item">-->
                    <#--<a href="resource.ftl"><i class="fa fa-tags fa-fw"></i>&nbsp;资源分享</a>-->
                <#--</li>-->
                <#--<li class="layui-nav-item">-->
                        ...
                        <#--<div class="layui-tab-item">-->
                            <#--<div class="aboutinfo">-->
                                ...
                                <#--<div class="aboutinfo-contact">-->
                                    ...
                                    <#--<a target="_blank" title="文章专栏" href="article.ftl"><i class="fa fa-file-text fa-2x"></i></a>-->
                                    <#--<a target="_blank" title="资源分享" href="resource.ftl"><i class="fa fa-tags fa-2x"></i></a>-->
                                    <#--<a target="_blank" title="点点滴滴" href="timeline.ftl"><i class="fa fa-hourglass-half fa-2x"></i></a>-->
                                <#--</div>-->
    ...
    <#--<ul class="layui-nav layui-nav-tree layui-nav-side blog-nav-left layui-hide" lay-filter="nav">-->
        ...
        <#--</li>-->
        <#--<li class="layui-nav-item">-->
            <#--<a href="timeline.ftl"><i class="fa fa-road fa-fw"></i>&nbsp;点点滴滴</a>-->
        <#--</li>-->
        <#--<li class="layui-nav-item layui-this">-->
            <#--<a href="about.ftl"><i class="fa fa-info fa-fw"></i>&nbsp;关于本站</a>-->
        <#--</li>-->
